...
values={'NODE_ENV':'production','HOST':'127.0.0.1','PORT':'3010','RESULTADOS_DATABASE_URL':f'postgresql://resultados_app:{dbpass}@127.0.0.1:5432/resultados_prod','SESSION_HMAC_KEY':secrets.token_hex(32),'CORS_ORIGINS':'https://resultados.107.175.132.15.nip.io','PATIENT_PORTAL_URL':'https://resultados.107.175.132.15.nip.io/resultados','STORAGE_DRIVER':'local-encrypted','STORAGE_ENCRYPTION_KEY':secrets.token_hex(32),'PRIVATE_STORAGE_DIR':'/var/lib/montalvo-resultados/files','CLAMAV_HOST':'127.0.0.1','CLAMAV_PORT':'3310','NOTIFICATIONS_ENABLED':'false','NOTIFICATION_DAILY_LIMIT':'100'}
